            ...
            <div className='relative overflow-hidden rounded-[30px] bg-[#EDE3D0] px-6 py-20 sm:px-10 md:py-24 lg:px-14 lg:py-28'>
                ...
                <div className='relative z-10 mx-auto max-w-6xl'>
                    ...
                    <div className='grid grid-cols-1 items-center gap-16 lg:grid-cols-2'>
                        <div className='relative h-105 w-full overflow-hidden rounded-3xl shadow-[0_30px_60px_rgba(0,0,0,0.25)] sm:h-120 lg:h-140'>
                            <Image src='/images/interior.avif' alt='Leaf Deck Cafe interior' fill className='object-cover brightness-110 contrast-105 saturate-105 transition-transform duration-700 hover:scale-[1.02]' />
