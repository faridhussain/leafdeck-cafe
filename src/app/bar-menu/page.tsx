...
export default function BarMenuPage() {
    ...
    return (
        <main className='min-h-screen bg-[#1B1611] text-white/95'>
            ...
            <section className='relative h-[45vh] overflow-hidde sm:h-[50vh]'>
                    ...
                    <div className='hidden lg:block'>
                        <div className='sticky top-0 flex h-screen items-center'>
                            <aside className='w-full'>
                                <div className='flex flex-col rounded-3xl bg-[#1B1611] px-6 py-6 shadow-[0_18px_40px_rgba(0,0,0,0.18)]'>
                                    <div className='relative'>
                                        ...
                                        <input
                                            ...
                                            className={`${interTight.className} w-full rounded-2xl border border-[#3A2F28] bg-[#241D18] py-3 pl-11 pr-4 text-[14px] text-[#F4EDE1] placeholder:text-[#9C8B7B] outline-none transition-all duration-300 focus:border-[#6A5442]`}
                                        />
                                    </div>
            ...
            <div className='fixed bottom-2 left-1/2 z-40 w-[95%] max-w-sm -translate-x-1/2 lg:hidden'>
                <div className='flex items-center gap-2 rounded-xl border border-white/10 bg-[#1B1611]/95 p-1.5 shadow-2xl backdrop-blur-xl'>
